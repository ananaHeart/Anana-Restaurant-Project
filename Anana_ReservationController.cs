...
namespace Anana_Restaurant.Controllers
{
    public class ReservationController : Controller
    {
        ...
        public
        ReservationController(IReservationService ReservationService, IRestaurantService
        RestaurantService)
        {
        ...
        public IActionResult Add(ObjectId
        restaurantId)
        {
            var selectedRestaurant =
            _RestaurantService.GetRestaurantById(restaurantId);
            ReservationAddViewModel
            reservationAddViewModel = new ReservationAddViewModel();
            ...
            return
            View(reservationAddViewModel);
        }
        [HttpPost]
        public IActionResult
        Add(ReservationAddViewModel
        reservationAddViewModel)
        {
            Reservation newReservation = new()
            {
                ...
                date =
            reservationAddViewModel.Reservation.date,
            };
        ...
        [HttpPost]
        public IActionResult Edit(Reservation
        reservation)
        {
            try
            {
                ...
                else
                {
                    ...
                    $"Reservation with ID {reservation.Id} does not exist!");
                }
            }
            catch (Exception ex)
            {
                ModelState.AddModelError("",
                $"Updating the reservation failed, please try again! Error: { ex.Message}");
            }
...
public IActionResult Delete(string Id)
        ...
        Delete(Reservation reservation)
        {
            if (reservation.Id == null)
            {
                ...
                "Deleting the reservation failed, invalid ID!";
            return View();
            }
            ...
            {
                ViewData["ErrorMessage"] =
                $"Deleting the reservation failed, please try again! Error: { ex.Message}";
            }
var selectedRestaurant =
_ReservationService.GetReservationById(
reservation.Id);
